...
O sistema em questão possui a \abbrev{FRF}{Função de Resposta em Frequência} FRF (Função de Resposta em Frequência) apresentada na \cref{fig:FRF_all}

\begin{figure}[h]
	\centering
	\includegraphics[trim={2.5cm, 0cm, 2.5cm, 2.5cm}, scale=0.55]{FRF_all}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{sistemaf}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{FRF_i2_o2}
